...
REGISTRY_NORM = ROOT / 'registry_normalized_20260405.json'
OUT = ROOT / 'image_validation_20260405.json'
TIMEOUT = 25
HEADERS = {'User-Agent': 'Mozilla/5.0'}

registry = json.loads(REGISTRY_NORM.read_text(encoding='utf-8')) if REGISTRY_NORM.exists() else []
